...
int8_t request_structure_memory(uint8_t index, enum PID_type_t type)
{
    switch (type) {
        case rotating_speed:
            ...
            /* 申请内存空间以存储PID操作所需的数据 */
            rotating_speed_list[rotating_speed_count] =
                (struct rotating_speed_t*)pvPortMalloc(sizeof(struct rotating_speed_t));
        ...
        case relative_angle:
            /* 同上 */
            relative_angle_list[relative_angle_count] =
                (struct relative_angle_t*)pvPortMalloc(sizeof(struct relative_angle_t));
        ...
        case absolute_angle:
            /* 同上 */
            absolute_angle_list[absolute_angle_count] =
                (struct absolute_angle_t*)pvPortMalloc(sizeof(struct absolute_angle_t));
        ...
        case relative_angle_cascade:
            /* 同上 */
            relative_angle_cascade_list[relative_angle_cascade_count] =
                (struct relative_angle_cascade_t*)pvPortMalloc(sizeof(struct relative_angle_cascade_t));

            memset((void*)relative_angle_cascade_list[relative_angle_cascade_count],
                   0,
                   sizeof(struct relative_angle_cascade_t));

            motor_info_list[index]->PID_structure_addr =
                (void*)relative_angle_cascade_list[relative_angle_cascade_count];
        ...
        case absolute_angle_cascade:
            /* 同上 */
            absolute_angle_cascade_list[absolute_angle_cascade_count] =
                (struct absolute_angle_cascade_t*)pvPortMalloc(sizeof(struct absolute_angle_cascade_t));

            memset((void*)absolute_angle_cascade_list[absolute_angle_cascade_count],
                   0,
                   sizeof(struct absolute_angle_cascade_t));

            motor_info_list[index]->PID_structure_addr =
                (void*)absolute_angle_cascade_list[absolute_angle_cascade_count];
        ...
        case gyro_angle_cascade:
            /* 同上 */
            gyro_angle_cascade_list[gyro_angle_cascade_count] =
                (struct gyro_angle_cascade_t*)pvPortMalloc(sizeof(struct gyro_angle_cascade_t));
        ...
        case vision_angle_cascade:
            /* 同上 */
            vision_angle_cascade_list[vision_angle_cascade_count] =
                (struct vision_angle_cascade_t*)pvPortMalloc(sizeof(struct vision_angle_cascade_t));

            memset(
                (void*)vision_angle_cascade_list[vision_angle_cascade_count], 0, sizeof(struct vision_angle_cascade_t));
...
int8_t release_structure_memory(uint8_t index)
{
    ...
    switch (type) {
        case rotating_speed: rotating_speed_count--; break;

        case relative_angle: relative_angle_count--; break;

        case absolute_angle: absolute_angle_count--; break;

        case relative_angle_cascade: relative_angle_cascade_count--; break;

        case absolute_angle_cascade: absolute_angle_cascade_count--; break;

        case gyro_angle_cascade: gyro_angle_cascade_count--; break;
